...
async function generateVisualReport() {
  const expectedDir = path.join(process.cwd(), 'test/visual/screenshots');
  const actualDir = path.join(process.cwd(), 'test/visual/actual-screenshots');
  const outputFile = path.join(process.cwd(), 'test/visual/report/index.html');
